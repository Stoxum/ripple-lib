...
import {Path, GetPaths, StoxumdPathsResponse} from '../pathfind-types'
...
function parseAlternative(sourceAddress: string, destinationAddress: string,
  destinationAmount: StoxumdAmount, alternative: any
): Path {
...
function parsePathfind(pathfindResult: StoxumdPathsResponse): GetPaths {
